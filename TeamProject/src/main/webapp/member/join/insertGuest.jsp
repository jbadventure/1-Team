...
<!-- contents -->
<h1 id="guestjoin">게스트 회원가입</h1>

<!-- form -->
<form action="insertProGuest.me" method="post" id="frInsertGuest">
<div id="InsertGuestBox">
...
<input type="button" value="회원가입" id="btn1" style="width:252px;">
</div>
</form>
